...
struct qt_meta_stringdata_CLASSSignENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSignENDCLASS = QtMocHelpers::stringData(
    "Sign",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSignENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Sign::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSignENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSignENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSignENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Sign::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSignENDCLASS.stringdata0))
